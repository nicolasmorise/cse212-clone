...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The que does not correctly manage lowering turns and add playes again.
    ...
    // Defect(s) Found: The rotation from the queue is incorect because players were only added when turns > 1.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Player with infinete turns aren't added again.
    ...
    // Defect(s) Found: Player with negative turns aren't added again.
    ...
    // Defect(s) Found: No problem found.
